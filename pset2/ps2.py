...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.cleanedTiles.add((math.floor(pos.getX()), math.floor(pos.getY())))
    ...
    def getRandomPosition(self):
        ...
        """
        xTile = random.randrange(self.width)
        xReal = random.randrange(10)
        xVal = float(str(xTile) + "." + str(xReal))

        yTile = random.randrange(self.height)
        yReal = random.randrange(10)
        yVal = float(str(yTile) + "." + str(yReal))
...
# print(runSimulation(5, 5.0, 40, 40, 1.0, 30, StandardRobot))
...
# print(runSimulation(1, 1.0, 40, 40, 1.0, 30, RandomWalkRobot))
